...
public class FutureM2MClientTest extends TestBase{

	@Test(enabled = true, priority = 1)
	public void manualTxnAdjmentFutureM2MTestClientTest() {
		FutureM2MPage futureM2MPage= PageFactory.initElements(driver, FutureM2MPage.class);
		futureM2MPage.manualTxnAdjmentFutureM2MPageClientTest();
	}
