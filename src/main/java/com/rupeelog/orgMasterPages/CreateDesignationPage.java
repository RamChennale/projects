...
public class CreateDesignationPage {
	...
	@FindBy(id = "shortName")
	@CacheLookup
	private WebElement designationShortName;
	
	@FindBy(id = "save")
	@CacheLookup
	private WebElement save;
	
	public  CreateDesignationPage(WebDriver driver){
		this.driver=driver;
	}
	
public void createDesignationPageTest() {
		...
		ElementWait.isElementVisible(Designation);
		...
		ElementWait.isElementVisible(designationName);
		designationName.sendKeys(file.getMasterTestData("designationName"));
		
		ElementWait.isElementVisible(designationShortName);
		designationShortName.sendKeys(file.getMasterTestData("designationShortName"));
		...
		try{
			...
			System.out.println("designation creation :"+alert.getText());
			alert.accept();
