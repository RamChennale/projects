...
public class JSONParsingInRestAssured {
...
*/
		...
		List<String> allEmployeeNames = jsonPathValidator.getList("data.employee_name");
		...
		String employeeAge = jsonPathValidator.getString("data.employee_age");
		System.out.println(employeeAge);

		// 5. To get the name of the sixth employee in the list using 2 ways:
		// 1.
		String sixthEmployeeName = jsonPathValidator.getString("data.employee_name[5]");
		System.out.println("Sixth EmployeeName: "+sixthEmployeeName);
		// 2.
		...
		if (Integer.parseInt(jsonPathValidator.getString("employee_salary[9]")) > 100) {
			System.out.println("True - 10th employee salary is " + jsonPathValidator.getString("employee_salary[9]")
					+ " which is greater than 100");
		} else {
			System.out.println("False - 10th employee salary is " + jsonPathValidator.getString("employee_salary[9]")
					+ " which is lesser than 100");
		}
