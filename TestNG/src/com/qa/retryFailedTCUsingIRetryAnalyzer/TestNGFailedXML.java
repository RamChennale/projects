...
public class TestNGFailedXML {
	...
	@Test(priority=1,retryAnalyzer=RetryUsingIRetryAnalyzer.class)
	public void test1() {
		softAssert= new SoftAssert();
	...
	@Test(priority=2,retryAnalyzer=RetryUsingIRetryAnalyzer.class)
	public void test2() {
		softAssert= new SoftAssert();
	...
	@Test(priority=3,retryAnalyzer=RetryUsingIRetryAnalyzer.class)
	public void test3() {
		softAssert= new SoftAssert();
	...
	@Test(priority=4, testName="TestCaseWithPriority4",retryAnalyzer=RetryUsingIRetryAnalyzer.class)
	public void test4() {
	...
	@Test(priority=5,retryAnalyzer=RetryUsingIRetryAnalyzer.class)
	...
	@Test(priority=6,retryAnalyzer=RetryUsingIRetryAnalyzer.class)
